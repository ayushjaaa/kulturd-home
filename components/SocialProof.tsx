...
export const SocialProof: React.FC = () => {
  return (
    <section className="py-32 bg-[#E9E4D6] relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-20">
          {/* Polaroid Collage */}
          <div className="lg:w-1/2 relative h-[500px] md:h-[650px] w-full max-w-lg">
            <motion.div 
          ...
          <div className="lg:w-1/2">
            ...
            <motion.blockquote 
              ...
              viewport={{ once: true }}
              className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-10"
            >
